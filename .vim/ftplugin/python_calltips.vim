...
"    Python_Calltips 1.02
"    (C) Copyright 2004 by tocer deng   MAIL: tocer.deng@gmail.com
"
"    Note: Fixed/Updated 2008-02-21 by Jay Taylor <outtatime@gmail.com> for vim7
"          Added missing parenthesis in if &filetype == "python".  Now the script
"          works im vim7.
"          I also added a toggle feature which maps to <F9>.
"
...
if exists("g:loaded_python_calltips") && g:loaded_python_calltips==1
    echomsg ""
    echomsg "Warning: python_calltips.vim already loaded!  Check your .vimrc file.."
    echomsg ""
    finish
endif
...
endfunc
let s:toggle = 0
map <F9> :call <SID>ToggleCalltips()<CR>
...
func! <SID>EndCalltips()
    ...
    "FIXME: disable all python buffer mapkeys while user end calltips
    execute "python CT_UnMapKeys()"
    execute "python CT_CloseTipsWin()"            
    execute "python CT_DelUnusedObject()"         
endfunc
